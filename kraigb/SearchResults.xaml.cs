...
namespace kraigb
{
    ...
    /// </summary>
    public sealed partial class SearchResults : kraigb.Common.LayoutAwarePage
    {
        ...
        {
            pageTitle.Text = "Search results for \"" + App.page_title + "\"";
            ...
            {
                await feedDataSource.GetFeedsAsync("search", navigationParameter.ToString());
            }
