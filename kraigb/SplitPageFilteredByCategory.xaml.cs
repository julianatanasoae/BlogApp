...
namespace kraigb
{
    ...
    /// </summary>
    public sealed partial class SplitPageFilteredByCategory : kraigb.Common.LayoutAwarePage
    {
        ...
        public SplitPageFilteredByCategory()
        {
        ...
        protected async override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            {
                await feedDataSource.GetFeedsAsync("category", navigationParameter.ToString());
            }
